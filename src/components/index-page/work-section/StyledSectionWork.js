...
const StyledSectionWork = () => {
  ...
  return (
    <StyledSectionTwo id="work">
      ...
      <h2>Work</h2>
      <ProjectsWrapper>
        <H3>You can see the repo for this website <a href={"https://github.com/paulcooke/paulcooke.github.io/tree/source"} target="_blank">here</a>. It was built with React using Hooks and Styled Components, generated by Gatsby.</H3>
        <br />
